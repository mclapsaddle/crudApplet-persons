...
if($result || !filter_var($email, FILTER_VALIDATE_EMAIL) ){
	...
	echo "<a href='display_create_form_persons.php'>Back To register</a>";
	header("Location: display_create_form_persons.php?" 
			. "role=$role"
			."&" . "fname=$fname"
			."&" . "lname=$lname"
			."&" . "email=$email"
...
$pdo->query($sql); # execute the query
	...
	echo "Invaild Password, Must be at least 16 charcters, have 1 uppercase, 1 lowercase, and 1 spiecal character";
	echo "<a href='display_create_form_persons.php'>Back To register</a>";
	header("Location: display_create_form_persons.php?" 
. "role=$role"
			."&" . "fname=$fname"
